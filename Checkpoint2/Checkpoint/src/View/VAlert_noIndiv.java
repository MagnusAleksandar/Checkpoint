 ...
 * @author alxev
 */
public class VAlert_noIndiv extends javax.swing.JFrame {

    /**
     * Creates new form Alert
     */
    public VAlert_noIndiv() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Individuo no se encuentra en el edificio o entró con vehículo.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAlert_noIndiv.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VAlert_noIndiv().setVisible(true);
            }
        });
    }
