 ...
 * @author alxev
 */
public class VAlert_noTienV extends javax.swing.JFrame {

    /**
     * Creates new form Alert
     */
    public VAlert_noTienV() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Debe salir con vehículo. Ingresó por la entrada vehicular.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAlert_noTienV.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VAlert_noTienV().setVisible(true);
            }
        });
    }
