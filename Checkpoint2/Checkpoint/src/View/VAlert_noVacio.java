 ...
 * @author alxev
 */
public class VAlert_noVacio extends javax.swing.JFrame {

    /**
     * Creates new form Alert
     */
    public VAlert_noVacio() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAlert_noVacio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VAlert_noVacio().setVisible(true);
            }
        });
    }
