 ...
 * @author alxev
 */
public class VAlert_noVehi extends javax.swing.JFrame {

    /**
     * Creates new form Alert
     */
    public VAlert_noVehi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("El usuario no entró con vehículo.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAlert_noVehi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VAlert_noVehi().setVisible(true);
            }
        });
    }
