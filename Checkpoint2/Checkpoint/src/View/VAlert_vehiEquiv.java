 ...
 * @author alxev
 */
public class VAlert_vehiEquiv extends javax.swing.JFrame {

    /**
     * Creates new form Alert
     */
    public VAlert_vehiEquiv() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Debe salir con el mismo vehículo con el que ingresó.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAlert_vehiEquiv.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VAlert_vehiEquiv().setVisible(true);
            }
        });
    }
