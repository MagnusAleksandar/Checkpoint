 ...
 * @author alxev
 */
public class VAlert_vehiNoAut extends javax.swing.JFrame {

    /**
     * Creates new form Alert
     */
    public VAlert_vehiNoAut() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alerta de seguridad");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAlert_vehiNoAut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VAlert_vehiNoAut().setVisible(true);
            }
        });
    }
