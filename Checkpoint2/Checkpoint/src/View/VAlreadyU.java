 ...
 * @author alxev
 */
public class VAlreadyU extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAlreadyU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
