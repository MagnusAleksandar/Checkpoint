 ...
 * @author alxev
 */
public class VAlreadyV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("El vehiculo ya se encuentra en el edificio.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAlreadyV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
