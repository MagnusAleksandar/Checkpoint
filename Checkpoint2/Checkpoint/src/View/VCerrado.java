 ...
 * @author alxev
 */
public class VCerrado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("No hay nadie adentro. Que tenga buena noche.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCerrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
