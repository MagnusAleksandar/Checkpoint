 ...
 * @author alxev
 */
public class VNoEntry extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No se puede salir.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VNoEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
