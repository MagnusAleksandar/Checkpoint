 ...
 * @author alxev
 */
public class VNoEntryYet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No se puede generar reporte.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VNoEntryYet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VNoEntryYet().setVisible(true);
            }
        });
    }
