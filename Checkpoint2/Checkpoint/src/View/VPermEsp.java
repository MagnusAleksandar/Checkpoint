 ...
 * @author alxev
 */
public class VPermEsp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Seleccione una opción válida.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VPermEsp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
