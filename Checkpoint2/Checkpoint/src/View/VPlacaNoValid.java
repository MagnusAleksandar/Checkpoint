 ...
 * @author alxev
 */
public class VPlacaNoValid extends javax.swing.JFrame {

    /**
     * Creates new form VNoValid
     */
    public VPlacaNoValid() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese una placa válida.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VPlacaNoValid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VPlacaNoValid().setVisible(true);
            }
        });
    }
