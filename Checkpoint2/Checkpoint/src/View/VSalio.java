 ...
 * @author alxev
 */
public class VSalio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Salida permitida.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VSalio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
