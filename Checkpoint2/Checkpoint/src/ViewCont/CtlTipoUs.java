...
public class CtlTipoUs implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource().equals(vtu.regBtn))
            ...
            if(vtu.rolUSlider.getSelectedItem().equals("[Seleccione uno]")||vtu.tipoEntrada.getSelectedItem().equals("[Seleccione uno]"))
                vpe.setVisible(true);
            else if(vtu.idTxt.getText().isEmpty())
                vid.setVisible(true);
            else if(!vtu.rolUSlider.getSelectedItem().equals("Docente")||!vtu.rolUSlider.getSelectedItem().equals("Estudiante"))
