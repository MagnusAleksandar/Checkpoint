...
public class CtlTipoVeh implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource().equals(vtv.resetBtn))
            ...
            if(vtv.rolUSlider.getSelectedItem().equals("[Seleccione uno]")||vtv.tipoVSlider.getSelectedItem().equals("[Seleccione uno]"))
                vpe.setVisible(true);
                ...
                String rol="";
                if(vtv.rolUSlider.getSelectedItem().equals("Docente")||vtv.rolUSlider.getSelectedItem().equals("Estudiante")){
                    ...
                    if(vtv.selNo.isSelected())
                        ...
                        rol="perm";
                    else vpe.setVisible(true);
                }else rol=vtv.rolUSlider.getSelectedItem().toString();
